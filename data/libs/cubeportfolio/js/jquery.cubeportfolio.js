...
! function(a, b, c, d) {
    ...
    function e(b, c, d) { /*eslint validthis: true */
        var f, g = this,
            h = "cbp";
                    ...
                    var e = b.find("img").map(function(b, c) {
                            ...
                            if (c.hasAttribute("width") && c.hasAttribute("height")) {
                                ...
                                if (null === d.checkSrc(c)) d.removeAttrImage(c);
                                    ...
                                    var e = a("<img>");
                                    e.on("load.cbp error.cbp", function() { a(this).off("load.cbp error.cbp"), d.removeAttrImage(c) }), c.srcset ? (e.attr("sizes", c.sizes || "100vw"), e.attr("srcset", c.srcset)) : e.attr("src", c.src)
                                }
                                return null
                            }
                            return d.checkSrc(c)
...
jQuery.fn.cubeportfolio.options = {
        ...
        e["public"] = {
            ...
            filter: function(b, c) {
                ...
                if (!g.isAnimating) {
                    if (g.isAnimating = !0,
                        // register callback function
                        a.isFunction(c) && g.registerEvent("filterFinish", c, !0), a.isFunction(b)) { if (f = b.call(g, g.blocks), f === d) throw new Error("When you call cubeportfolio API `filter` method with a param of type function you must return the blocks that will be visible.") } else {
            ...
            append: function(b, c) {
                ...
                return d.isAnimating || f.length < 1 ? void(a.isFunction(c) && c.call(d, f)) : (d.isAnimating = !0, void(d.singlePageInline && d.singlePageInline.isOpen ? d.singlePageInline.close("promise", { callback: function() { d.addItems(f, c, "append") } }) : d.addItems(f, c, "append")))
            },
            /*
             * Prepend elements
             */
            prepend: function(b, c) {
                var d = e["private"].checkInstance.call(this, "prepend"),
                    f = a(b).filter(".cbp-item");
                return d.isAnimating || f.length < 1 ? void(a.isFunction(c) && c.call(d, f)) : (d.isAnimating = !0, void(d.singlePageInline && d.singlePageInline.isOpen ? d.singlePageInline.close("promise", { callback: function() { d.addItems(f, c, "prepend") } }) : d.addItems(f, c, "prepend")))
            },
            /*
            ...
            remove: function(b, c) {
                var d = e["private"].checkInstance.call(this, "remove"),
                    f = a(b).filter(".cbp-item");
                return d.isAnimating || f.length < 1 ? void(a.isFunction(c) && c.call(d, f)) : (d.isAnimating = !0, void(d.singlePageInline && d.singlePageInline.isOpen ? d.singlePageInline.close("promise", { callback: function() { d.removeItems(f, c) } }) : d.removeItems(f, c)))
            }
        }
    }(jQuery, window, document),
    function(a, b, c, d) {
    ...
    function(a, b, c, d) {
            ...
            c.parent = b, c.filters = a(b.options.filters), c.filterData = [], b.registerEvent("afterPlugins", function(a) {
                ...
                b.registerEvent("resetFiltersVisual", function() {
                    ...
                    c.filters.each(function(b, c) {
                        ...
                        a.each(d, function(a, b) { var c = e.filter('[data-filter="' + b + '"]'); return c.length ? (c.addClass("active").siblings().removeClass("active"), d.splice(a, 1), !1) : void 0 })
        ...
        e.prototype.registerFilter = function() {
                ...
                b.wrap = b.filters.find(".cbp-l-filters-dropdownWrap").on({ "mouseover.cbp": function() { a(this).addClass("cbp-l-filters-dropdownWrap-open") }, "mouseleave.cbp": function() { a(this).removeClass("cbp-l-filters-dropdownWrap-open") } }), b.filters.each(function(e, f) {
                    ...
                    g.hasClass("cbp-l-filters-dropdown") && (j.wrap = g.find(".cbp-l-filters-dropdownWrap"), j.header = g.find(".cbp-l-filters-dropdownHeader"), j.headerText = j.header.text()),
                        ...
                        c.$obj.cubeportfolio("showCounter", i), a.each(d, function(a, b) { return i.filter('[data-filter="' + b + '"]').length ? (h = b, d.splice(a, 1), !1) : void 0 }), a.data(f, "filterName", h), b.filterData.push(f), b.filtersCallback(j, i.filter('[data-filter="' + h + '"]')), i.on("click.cbp", function() {
                            var d = a(this);
                            if (!d.hasClass("active") && !c.isAnimating) {
            ...
            }, e.prototype.filtersCallback = function(b, c) { a.isEmptyObject(b) || (b.wrap.trigger("mouseleave.cbp"), b.headerText ? b.headerText = "" : b.header.html(c.html())), c.addClass("active").siblings().removeClass("active") },
            /**
    ...
    function(a, b, c, d) {
        ...
        g["private"].lazyLoadScroll = new g["private"].publicEvents("scroll.lazyLoad", 300), e.prototype.loadImages = function() {
            ...
            0 !== c.length && (b.screenHeight = h.height(), c.each(function(c, d) {
                ...
                null === b.parent.checkSrc(a("<img>").attr("src", f)) ? (b.removeLazyLoad(d, f), e.removeClass(b.options.loadingClass)) : (e.addClass(b.options.loadingClass), a("<img>").on("load.cbp error.cbp", function() { b.removeLazyLoad(d, f, e) }).attr("src", f))
            }))
            ...
            return d >= 0 && e >= d
        }, e.prototype.destroy = function() { g["private"].lazyLoadScroll.destroyEvent(this) }, g.plugins.lazyLoad = function(a) { return new e(a) }
    }(jQuery, window, document),
    function(a, b, c, d) {
        "use strict";
            ...
            c.parent.$obj.on("initComplete.cbp", function() {
                Object.create({
                    ...
                    getNewItems: function() {
                        var b, e, g = this;
                        g.isActive || c.loadMore.hasClass("cbp-l-loadMore-stop") || (b = c.loadMore.offset().top - 200, e = d.scrollTop() + d.height(), b > e || (g.isActive = !0, g.numberOfClicks++, a.ajax({ url: c.createURL(c.loadMore.attr("href"), g.numberOfClicks), type: "GET", dataType: "HTML" }).done(function(a) {
                            var b = a.replace(/(\r\n|\n|\r)/gm, ""),
                            ...
                            h = -1 === j ? b.lastIndexOf("</") : b.lastIndexOf("</", j), c.parent.$obj.cubeportfolio("append", b.substring(i, h), function() {-1 === j ? (c.loadMore.addClass("cbp-l-loadMore-stop"), f["private"].loadMoreScroll.destroyEvent(this), c.parent.$obj.off("filterComplete.cbp")) : (g.isActive = !1, d.trigger("scroll.loadMore")) })
                        }).fail(function() { g.isActive = !1 })))
                    }
                }).init()
            })
        }, e.prototype.destroy = function() {
            ...
            g = {
                    ...
                    if (
                        ...
                        if (
                            ...
                            if ( // remove first item
                                a.each(g, function(b, c) { return f.cubeportfolio.blocksOn.each(function(b, d) { var g = a(d).find(f.options.singlePageDelegate + '[href="' + c + '"]'); return g.length ? (e = g, !1) : void 0 }), e ? !1 : void 0 }), e) {
                                f.url = h;
                                var i = e,
                ...
                openSinglePageInline: function(c, d, e) {
                    ...
                    if (j.wrap[0].style.height = j.wrap.outerHeight(!0) + "px",
                        ...
                        j.scrollTop !== n ? a("html,body").animate({ scrollTop: n }, 350).promise().then(function() { j.resizeSinglePageInline(), j.deferredInline.resolve() }) : (j.resizeSinglePageInline(), j.deferredInline.resolve())
    ...
    function(a, b, c, d) {
        ...
        function e(b) {
            ...
            c.searchInput.on("keyup.cbp paste.cbp", function(b) {
                b.preventDefault();
                var e = a(this);
                clearTimeout(d), d = setTimeout(function() { c.runEvent.call(c, e) }, 350)
