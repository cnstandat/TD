...
jQuery.trumbowyg = {
    langs: {
        en: {
            viewHTML: "Xem mã HTML",// 'View HTML',
            undo: 'Undo',
            redo: 'Redo',
...
(function (navigator, window, document, $) {
    ...
    Trumbowyg.prototype = {
        ...
        buildBtnPane: function () {
            ...
            $btnPane.append($('<button/>').addClass("mx-show show_trum").append($('<span/>').addClass("line")));
            t.$box.prepend($btnPane);
            $('.show_trum').on('click', function () {
