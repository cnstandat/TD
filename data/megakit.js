/*eslint eqeqeq: "error"*/
; (function () {
    function t() { } function e(t, e, o) {
        function r(e) { var n = p, o = s; return p = s = u, g = e, y = t.apply(o, n) } function f(t) { var n = t - m; return t -= g, m === u || n >= e || 0 > n || v && t >= b } function a() { var t = h(); if (f(t)) return c(t); var n, o = setTimeout; n = t - g, t = e - (t - m), n = v ? O(t, b - n) : t, d = o(a, n) } function c(t) { return d = u, T && p ? r(t) : (p = s = u, y) } function l() { var t = h(), n = f(t); if (p = arguments, s = this, m = t, n) { if (d === u) return g = t = m, d = setTimeout(a, e), j ? r(t) : y; if (v) return d = setTimeout(a, e), r(m) } return d === u && (d = setTimeout(a, e)), y } var p, s, b, y, d, m, g = 0, j = false, v = false, T = true;
        if (typeof t != "function") throw new TypeError("Expected a function"); return e = i(e) || 0, n(o) && (j = !!o.leading, b = (v = "maxWait" in o) ? x(i(o.maxWait) || 0, e) : b, T = "trailing" in o ? !!o.trailing : T), l.cancel = function () { d !== u && clearTimeout(d), g = 0, p = m = s = d = u }, l.flush = function () { return d === u ? y : c(h()) }, l
    } function n(t) { var e = typeof t; return null != t && ("object" == e || "function" == e) } function o(t) { return null != t && typeof t == "object" } function r(t) {
        var e; if (!(e = typeof t == "symbol") && (e = o(t))) {
            if (null == t) t = t === u ? "[object Undefined]" : "[object Null]"; else if (v && v in Object(t)) {
                e = g.call(t, v); var n = t[v]; try { t[v] = u; var r = true } catch (t) { } var i = j.call(t); r && (e ? t[v] = n : delete t[v]), t = i
            } else t = j.call(t); e = "[object Symbol]" == t
        } return e
    } function i(t) { if (typeof t == "number") return t; if (r(t)) return f; if (n(t) && (t = typeof t.valueOf == "function" ? t.valueOf() : t, t = n(t) ? t + "" : t), typeof t != "string") return 0 === t ? t : +t; t = t.replace(a, ""); var e = l.test(t); return e || p.test(t) ? s(t.slice(2), e ? 2 : 8) : c.test(t) ? f : +t } var u, f = NaN, a = /^\s+|\s+$/g, c = /^[-+]0x[0-9a-f]+$/i, l = /^0b[01]+$/i, p = /^0o[0-7]+$/i, s = parseInt, b = typeof self == "object" && self && self.Object === Object && self, y = typeof global == "object" && global && global.Object === Object && global || b || Function("return this")(), d = (b = typeof exports == "object" && exports && !exports.nodeType && exports) && typeof module == "object" && module && !module.nodeType && module, m = Object.prototype, g = m.hasOwnProperty, j = m.toString, v = (m = y.Symbol) ? m.toStringTagBlog : u, x = Math.max, O = Math.min, h = function () {
        return y.Date.now()
...
setDocument = Sizzle.setDocument = function( node ) {
	...
	if ( (support.qsa = rnative.test( document.querySelectorAll )) ) {
		...
		assert(function( el ) {
			...
			// Support: Windows 8 Navtive Apps
		...
		if ( typeof selector === "string" ) {
			...
			if ( match && ( match[ 1 ] || !context ) ) {
				...
				if ( match[ 1 ] ) {
					...
					// HANDLE: $(html, props)
					if ( rsingleTagBlog.test( match[ 1 ] ) && jQuery.isPlainObject( context ) ) {
...
var
	...
	rxhtmlTagBlog = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,
...
jQuery.extend( {
	htmlPrefilter: function( html ) {
		return html.replace( rxhtmlTagBlog, "<$1></$2>" );
	},
...
jQuery.parseHTML = function( data, context, keepScripts ) {
	...
	parsed = rsingleTagBlog.exec( data );
	scripts = !keepScripts && [];
...
var _getLoopedId = function(index) {
		var numGallerys = mfp.items.length;
		if(index > numGallerys - 1) {
			return index - numGallerys;
		} else  if(index < 0) {
			return numGallerys + index;
		}
		return index;
	},
...
(function () {
    ...
    var Swiper = function (container, params) {
        ...
        var defaults = {
            ...
            prevButton: null,
            // Progress
            watchGallerysProgress: false,
            watchGallerysVisibility: false,
            // Cursor
            grabCursor: false,
            // Clicks
            preventClicks: true,
            preventClicksPropagation: true,
            slideToClickedGallery: false,
            // Lazy Loading
            lazyLoading: false,
            ...
            // loop
            loop: false,
            loopAdditionalGallerys: 0,
            loopedGallerys: null,
            // Control
            control: undefined,
            controlInverse: false,
            controlBy: 'slide', //or 'container'
            normalizeGalleryIndex: true,
            // Swiping/no swiping
            ...
            // Accessibility
            a11y: false,
            prevGalleryMessage: 'Previous slide',
            nextGalleryMessage: 'Next slide',
            firstGalleryMessage: 'This is the first slide',
            lastGalleryMessage: 'This is the last slide',
            ...
            onGalleryrMove: function (swiper, e)
            onGalleryChangeStart: function (swiper)
            onGalleryChangeEnd: function (swiper)
        ...
        if (s.params.parallax || s.params.watchGallerysVisibility) {
            s.params.watchGallerysProgress = true;
        }
        ...
        if (s.params.effect === 'cube') {
            ...
            s.params.centeredGallerys = false;
        ...
        function autoplay() {
            ...
            var activeGallery = s.slides.eq(s.activeIndex);
            if (activeGallery.attr('data-swiper-autoplay')) {
                autoplayDelay = activeGallery.attr('data-swiper-autoplay') || s.params.autoplay;
            }
        ...
        s.updateAutoHeight = function () {
            ...
            if (s.params.slidesPerView !== 'auto' && s.params.slidesPerView > 1) {
                for (i = 0; i < Math.ceil(s.params.slidesPerView) ; i++) {
                    ...
                    activeGallerys.push(s.slides.eq(index)[0]);
                }
            } else {
                activeGallerys.push(s.slides.eq(s.activeIndex)[0]);
            }

            // Find new height from heighest slide in view
            for (i = 0; i < activeGallerys.length; i++) {
                if (typeof activeGallerys[i] !== 'undefined') {
                    var height = activeGallerys[i].offsetHeight;
        ...
        s.updateGallerysSize = function () {
            ...
            for (i = 0; i < s.slides.length; i++) {
                ...
                if (s.params.slidesPerColumn > 1) {
                    ...
                    if (s.params.slidesPerColumnFill === 'column') {
                        ...
                        newGalleryOrderIndex = column + row * slidesNumberEvenToRows / slidesPerColumn;
                        slide
                            .css({
                                '-webkit-box-ordinal-group': newGalleryOrderIndex,
                                '-moz-box-ordinal-group': newGalleryOrderIndex,
                                '-ms-flex-order': newGalleryOrderIndex,
                                '-webkit-order': newGalleryOrderIndex,
                                'order': newGalleryOrderIndex
                            });
                    }
                    else {
                ...
                s.slides[i].swiperGallerySize = slideSize;
                s.slidesSizesGrid.push(slideSize);


                if (s.params.centeredGallerys) {
                    slidePosition = slidePosition + slideSize / 2 + prevGallerySize / 2 + spaceBetween;
                    if (prevGallerySize === 0 && i !== 0) slidePosition = slidePosition - s.size / 2 - spaceBetween;
            ...
            if (s.params.slidesPerColumn > 1) {
                ...
                if (s.params.centeredGallerys) {
                    ...
                    for (i = 0; i < s.snapGrid.length; i++) {
                        if (s.snapGrid[i] < s.virtualSize + s.snapGrid[0]) newGallerysGrid.push(s.snapGrid[i]);
                    }
                    s.snapGrid = newGallerysGrid;
                }
            }
            ...
            if (!s.params.centeredGallerys) {
                ...
                for (i = 0; i < s.snapGrid.length; i++) {
                    if (s.snapGrid[i] <= s.virtualSize - s.size) {
                        newGallerysGrid.push(s.snapGrid[i]);
                    }
                }
                s.snapGrid = newGallerysGrid;
            ...
            if (s.params.watchGallerysProgress) {
                s.updateGallerysOffset();
            }
        };
        s.updateGallerysOffset = function () {
            for (var i = 0; i < s.slides.length; i++) {
                s.slides[i].swiperGalleryOffset = s.isHorizontal() ? s.slides[i].offsetLeft : s.slides[i].offsetTop;
            }
        };

        /*=========================
          Dynamic Gallerys Per View
          ===========================*/
        s.currentGallerysPerView = function () {
            var spv = 1, i, j;
            if (s.params.centeredGallerys) {
                var size = s.slides[s.activeIndex].swiperGallerySize;
                var breakLoop;
                for (i = s.activeIndex + 1; i < s.slides.length; i++) {
                    if (s.slides[i] && !breakLoop) {
                        size += s.slides[i].swiperGallerySize;
                        spv++;
                ...
                for (j = s.activeIndex - 1; j >= 0; j--) {
                    if (s.slides[j] && !breakLoop) {
                        size += s.slides[j].swiperGallerySize;
                        spv++;
                        if (size > s.size) breakLoop = true;
                    }
                }
        ...
        /*=========================
          Galleryr/slides progress
          ===========================*/
        s.updateGallerysProgress = function (translate) {
            if (typeof translate === 'undefined') {
                translate = s.translate || 0;
            }
            if (s.slides.length === 0) return;
            if (typeof s.slides[0].swiperGalleryOffset === 'undefined') s.updateGallerysOffset();
            ...
            for (var i = 0; i < s.slides.length; i++) {
                ...
                var slideProgress = (offsetCenter + (s.params.centeredGallerys ? s.minTranslate() : 0) - slide.swiperGalleryOffset) / (slide.swiperGallerySize + s.params.spaceBetween);
                if (s.params.watchGallerysVisibility) {
                    var slideBefore = -(offsetCenter - slide.swiperGalleryOffset);
        ...
        s.updateProgress = function (translate) {
            ...
            if (s.params.watchGallerysProgress) s.updateGallerysProgress(translate);
        ...
        s.updateActiveIndex = function () {
            ...
            if (s.params.normalizeGalleryIndex) {
        ...
        s.updateClasses = function () {
            ...
            var activeGallery = s.slides.eq(s.activeIndex);
            // Active classes
            activeGallery.addClass(s.params.slideActiveClass);
            if (params.loop) {
                // Duplicate to all looped slides
                if (activeGallery.hasClass(s.params.slideDuplicateClass)) {
            ...
            // Next Gallery
            var nextGallery = activeGallery.next('.' + s.params.slideClass).addClass(s.params.slideNextClass);
            if (s.params.loop && nextGallery.length === 0) {
                nextGallery = s.slides.eq(0);
                nextGallery.addClass(s.params.slideNextClass);
            }
            // Prev Gallery
            var prevGallery = activeGallery.prev('.' + s.params.slideClass).addClass(s.params.slidePrevClass);
            if (s.params.loop && prevGallery.length === 0) {
                prevGallery = s.slides.eq(-1);
                prevGallery.addClass(s.params.slidePrevClass);
            }
            if (params.loop) {
                // Duplicate to all looped slides
                if (nextGallery.hasClass(s.params.slideDuplicateClass)) {
                    s.wrapper.children('.' + s.params.slideClass + ':not(.' + s.params.slideDuplicateClass + ')[data-swiper-slide-index="' + nextGallery.attr('data-swiper-slide-index') + '"]').addClass(s.params.slideDuplicateNextClass);
                }
                else {
                    s.wrapper.children('.' + s.params.slideClass + '.' + s.params.slideDuplicateClass + '[data-swiper-slide-index="' + nextGallery.attr('data-swiper-slide-index') + '"]').addClass(s.params.slideDuplicateNextClass);
                }
                if (prevGallery.hasClass(s.params.slideDuplicateClass)) {
                    s.wrapper.children('.' + s.params.slideClass + ':not(.' + s.params.slideDuplicateClass + ')[data-swiper-slide-index="' + prevGallery.attr('data-swiper-slide-index') + '"]').addClass(s.params.slideDuplicatePrevClass);
                }
                else {
                    s.wrapper.children('.' + s.params.slideClass + '.' + s.params.slideDuplicateClass + '[data-swiper-slide-index="' + prevGallery.attr('data-swiper-slide-index') + '"]').addClass(s.params.slideDuplicatePrevClass);
                }
            }
            ...
            if (s.paginationContainer && s.paginationContainer.length > 0) {
                // Current/Total
                var current,
                    total = s.params.loop ? Math.ceil((s.slides.length - s.loopedGallerys * 2) / s.params.slidesPerGroup) : s.snapGrid.length;
                if (s.params.loop) {
                    current = Math.ceil((s.activeIndex - s.loopedGallerys) / s.params.slidesPerGroup);
                    if (current > s.slides.length - 1 - s.loopedGallerys * 2) {
                        current = current - (s.slides.length - s.loopedGallerys * 2);
                    }
        ...
        s.updatePagination = function () {
            ...
            if (s.paginationContainer && s.paginationContainer.length > 0) {
                ...
                if (s.params.paginationType === 'bullets') {
                    var numberOfBullets = s.params.loop ? Math.ceil((s.slides.length - s.loopedGallerys * 2) / s.params.slidesPerGroup) : s.snapGrid.length;
        ...
        s.update = function (updateTranslate) {
            ...
            if (updateTranslate) {
                ...
                if (s.params.freeMode) {
                    ...
                    if ((s.params.slidesPerView === 'auto' || s.params.slidesPerView > 1) && s.isEnd && !s.params.centeredGallerys) {
        ...
        s.onResize = function (forceUpdatePagination) {
            ...
            var slideChangedByGalleryTo = false;
            if (s.params.freeMode) {
                ...
                s.updateClasses();
                if ((s.params.slidesPerView === 'auto' || s.params.slidesPerView > 1) && s.isEnd && !s.params.centeredGallerys) {
                    slideChangedByGalleryTo = s.slideTo(s.slides.length - 1, 0, false, true);
                }
                else {
                    slideChangedByGalleryTo = s.slideTo(s.activeIndex, 0, false, true);
                }
            }
            if (s.params.lazyLoading && !slideChangedByGalleryTo && s.lazy) {
                s.lazy.load();
            }
        ...
        s.onClickIndex = function (e) {
            ...
            if (s.params.loop) index = index + s.loopedGallerys;
            s.slideTo(index);
        };
        ...
        s.updateClickedGallery = function (e) {
            ...
            if (slide && slideFound) {
                s.clickedGallery = slide;
                s.clickedIndex = $(slide).index();
            }
            else {
                s.clickedGallery = undefined;
                s.clickedIndex = undefined;
                return;
            }
            if (s.params.slideToClickedGallery && s.clickedIndex !== undefined && s.clickedIndex !== s.activeIndex) {
                var slideToIndex = s.clickedIndex,
                    realIndex,
                    duplicatedGallerys,
                    slidesPerView = s.params.slidesPerView === 'auto' ? s.currentGallerysPerView() : s.params.slidesPerView;
                if (s.params.loop) {
                    if (s.animating) return;
                    realIndex = parseInt($(s.clickedGallery).attr('data-swiper-slide-index'), 10);
                    if (s.params.centeredGallerys) {
                        if ((slideToIndex < s.loopedGallerys - slidesPerView / 2) || (slideToIndex > s.slides.length - s.loopedGallerys + slidesPerView / 2)) {
                            s.fixLoop();
        ...
        s.onTouchMove = function (e) {
            ...
            if (s.params.freeMode || s.params.watchGallerysProgress) {
                s.updateActiveIndex();
            }
            if (s.params.freeMode) {
                //Velocity
            ...
            if (s.params.freeMode) {
                ...
                if (s.params.freeModeMomentum) {
                    ...
                    if (newPosition < s.maxTranslate()) {
                        ...
                        if (Math.abs(s.snapGrid[nextGallery] - newPosition) < Math.abs(s.snapGrid[nextGallery - 1] - newPosition) || s.swipeDirection === 'next') {
                            newPosition = s.snapGrid[nextGallery];
                        } else {
                            newPosition = s.snapGrid[nextGallery - 1];
                        }
                        if (!s.rtl) newPosition = -newPosition;
                    }
                    //Fix duration
        ...
        s.onTransitionStart = function (runCallbacks) {
            ...
            if (runCallbacks) {
                ...
                if (s.activeIndex !== s.previousIndex) {
                    s.emit('onGalleryChangeStart', s);
                    if (s.activeIndex > s.previousIndex) {
                        s.emit('onGalleryNextStart', s);
                    }
                    else {
                        s.emit('onGalleryPrevStart', s);
                    }
                }
        ...
        s.onTransitionEnd = function (runCallbacks) {
            ...
            if (runCallbacks) {
                ...
                if (s.activeIndex !== s.previousIndex) {
                    s.emit('onGalleryChangeEnd', s);
                    if (s.activeIndex > s.previousIndex) {
                        s.emit('onGalleryNextEnd', s);
                    }
                    else {
                        s.emit('onGalleryPrevEnd', s);
                    }
                }
            }
        ...
        s.createLoop = function () {
            ...
            if (s.params.slidesPerView === 'auto' && !s.params.loopedGallerys) s.params.loopedGallerys = slides.length;

            s.loopedGallerys = parseInt(s.params.loopedGallerys || s.params.slidesPerView, 10);
            s.loopedGallerys = s.loopedGallerys + s.params.loopAdditionalGallerys;
            if (s.loopedGallerys > slides.length) {
                s.loopedGallerys = slides.length;
            }

            var prependGallerys = [], appendGallerys = [], i;
            slides.each(function (index, el) {
                var slide = $(this);
                if (index < s.loopedGallerys) appendGallerys.push(el);
                if (index < slides.length && index >= slides.length - s.loopedGallerys) prependGallerys.push(el);
                slide.attr('data-swiper-slide-index', index);
            });
            for (i = 0; i < appendGallerys.length; i++) {
                s.wrapper.append($(appendGallerys[i].cloneNode(true)).addClass(s.params.slideDuplicateClass));
            }
            for (i = prependGallerys.length - 1; i >= 0; i--) {
                s.wrapper.prepend($(prependGallerys[i].cloneNode(true)).addClass(s.params.slideDuplicateClass));
            }
        };
        ...
        s.reLoop = function (updatePosition) {
            var oldIndex = s.activeIndex - s.loopedGallerys;
            s.destroyLoop();
            s.createLoop();
            s.updateGallerysSize();
            if (updatePosition) {
                s.slideTo(oldIndex + s.loopedGallerys, 0, false);
            }
        ...
        s.fixLoop = function () {
            ...
            if (s.activeIndex < s.loopedGallerys) {
                newIndex = s.slides.length - s.loopedGallerys * 3 + s.activeIndex;
                newIndex = newIndex + s.loopedGallerys;
                s.slideTo(newIndex, 0, false, true);
            }
                //Fix For Positive Oversliding
            else if ((s.params.slidesPerView === 'auto' && s.activeIndex >= s.loopedGallerys * 2) || (s.activeIndex > s.slides.length - s.params.slidesPerView * 2)) {
                newIndex = -s.slides.length + s.activeIndex + s.loopedGallerys;
                newIndex = newIndex + s.loopedGallerys;
                s.slideTo(newIndex, 0, false, true);
            }
        };
        /*=========================
          Append/Prepend/Remove Gallerys
          ===========================*/
        s.appendGallery = function (slides) {
            if (s.params.loop) {
                s.destroyLoop();
            }
        ...
        s.prependGallery = function (slides) {
            if (s.params.loop) {
                s.destroyLoop();
            }
        ...
        s.removeGallery = function (slidesIndexes) {
            if (s.params.loop) {
                s.destroyLoop();
                s.slides = s.wrapper.children('.' + s.params.slideClass);
            }
            ...
            if (s.params.loop) {
                s.slideTo(newActiveIndex + s.loopedGallerys, 0, false);
            }
            else {
                s.slideTo(newActiveIndex, 0, false);
            }
        ...
        s.removeAllGallerys = function () {
            var slidesIndexes = [];
            for (var i = 0; i < s.slides.length; i++) {
                slidesIndexes.push(i);
            }
            s.removeGallery(slidesIndexes);
        };
        ...
        s.effects = {
            fade: {
                setTranslate: function () {
                    for (var i = 0; i < s.slides.length; i++) {
                        var slide = s.slides.eq(i);
                        var offset = slide[0].swiperGalleryOffset;
                        var tx = -offset;
            ...
            coverflow: {
                setTranslate: function () {
                    ...
                    for (var i = 0, length = s.slides.length; i < length; i++) {
                        ...
                        var slideOffset = slide[0].swiperGalleryOffset;
        ...
        s.lazy = {
            ...
            loadImageInGallery: function (index, loadInDuplicate) {
                    ...
                    s.loadImage(_img[0], (src || background), srcset, sizes, false, function () {
                        ...
                        if (s.params.loop && loadInDuplicate) {
                            ...
                            if (slide.hasClass(s.params.slideDuplicateClass)) {
                                var originalGallery = s.wrapper.children('[data-swiper-slide-index="' + slideOriginalIndex + '"]:not(.' + s.params.slideDuplicateClass + ')');
                                s.lazy.loadImageInGallery(originalGallery.index(), false);
                            }
                            else {
                                var duplicatedGallery = s.wrapper.children('.' + s.params.slideDuplicateClass + '[data-swiper-slide-index="' + slideOriginalIndex + '"]');
                                s.lazy.loadImageInGallery(duplicatedGallery.index(), false);
                            }
                        }
            ...
            load: function () {
                ...
                if (s.params.watchGallerysVisibility) {
                    s.wrapper.children('.' + s.params.slideVisibleClass).each(function () {
                        s.lazy.loadImageInGallery($(this).index());
                    });
                }
                else {
                    if (slidesPerView > 1) {
                        for (i = s.activeIndex; i < s.activeIndex + slidesPerView ; i++) {
                            if (s.slides[i]) s.lazy.loadImageInGallery(i);
                        }
                    }
                    else {
                        s.lazy.loadImageInGallery(s.activeIndex);
                    }
                }
                if (s.params.lazyLoadingInPrevNext) {
                    if (slidesPerView > 1 || (s.params.lazyLoadingInPrevNextAmount && s.params.lazyLoadingInPrevNextAmount > 1)) {
                        ...
                        var nextGallery = s.wrapper.children('.' + s.params.slideNextClass);
                        if (nextGallery.length > 0) s.lazy.loadImageInGallery(nextGallery.index());

                        var prevGallery = s.wrapper.children('.' + s.params.slidePrevClass);
                        if (prevGallery.length > 0) s.lazy.loadImageInGallery(prevGallery.index());
                    }
                }
            },
        ...
        s.hashnav = {
            onHashCange: function (e, a) {
                ...
                var activeGalleryHash = s.slides.eq(s.activeIndex).attr('data-hash');
                if (newHash !== activeGalleryHash) {
        ...
        s.history = {
            init: function () {
                ...
                this.scrollToGallery(0, this.paths.value, s.params.runCallbacksOnInit);
            ...
            setHistoryPopState: function () {
                ...
                s.history.scrollToGallery(s.params.speed, s.history.paths.value, false);
            },
            ...
            scrollToGallery: function (speed, value, runCallbacks) {
                if (value) {
                    for (var i = 0, length = s.slides.length; i < length; i++) {
                        var slide = s.slides.eq(i);
        ...
        s.zoom = {
            ...
            toggleZoom: function (s, e) {
                var z = s.zoom;
                if (!z.gesture.slide) {
                    z.gesture.slide = s.clickedGallery ? $(s.clickedGallery) : s.slides.eq(s.activeIndex);
                    z.gesture.image = z.gesture.slide.find('img, svg, canvas');
                    z.gesture.imageWrap = z.gesture.image.parent('.' + s.params.zoomContainerClass);
                }
                if (!z.gesture.image || z.gesture.image.length === 0) return;
        ...
        s.a11y = {
            ...
            onEnterKey: function (event) {
                ...
                if ($(event.target).is(s.params.nextButton)) {
                    s.onClickNext(event);
                    if (s.isEnd) {
                        s.a11y.notify(s.params.lastGalleryMessage);
                    }
                    else {
                        s.a11y.notify(s.params.nextGalleryMessage);
                    }
                }
                else if ($(event.target).is(s.params.prevButton)) {
                    s.onClickPrev(event);
                    if (s.isBeginning) {
                        s.a11y.notify(s.params.firstGalleryMessage);
                    }
                    else {
                        s.a11y.notify(s.params.prevGalleryMessage);
                    }
                }
            ...
            init: function () {
                ...
                if (s.params.nextButton && s.nextButton && s.nextButton.length > 0) {
                    ...
                    s.a11y.addLabel(s.nextButton, s.params.nextGalleryMessage);
                }
                if (s.params.prevButton && s.prevButton && s.prevButton.length > 0) {
                    s.a11y.makeFocusable(s.prevButton);
                    s.a11y.addRole(s.prevButton, 'button');
                    s.a11y.addLabel(s.prevButton, s.params.prevGalleryMessage);
                }
        ...
        s.init = function () {
            ...
            if (s.params.loop) {
                s.slideTo(s.params.initialGallery + s.loopedGallerys, 0, s.params.runCallbacksOnInit);
            }
            else {
                s.slideTo(s.params.initialGallery, 0, s.params.runCallbacksOnInit);
                if (s.params.initialGallery === 0) {
